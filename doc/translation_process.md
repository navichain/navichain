...
2. Update `src/qt/bitcoin_locale.nrc` manually or via
...
To create a new language template, you will need to edit the languages manifest file `src/qt/bitcoin_locale.nrc` and add a new entry. Below is an example of the English language entry.
