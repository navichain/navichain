...
public:
    ...
    void SetNull()
    {
        ...
        nBits = 0;
        nNonce = 0;
        hashStateRoot.SetNull(); // nc
        hashUTXORoot.SetNull(); // nc
        vchBlockSig.clear();
    ...
    virtual bool IsProofOfStake() const //nc
    {
    ...
    CBlockHeader& operator=(const CBlockHeader& other) //nc
    {
        if (this != &other)
        {
...
public:
    ...
    std::pair<COutPoint, unsigned int> GetProofOfStake() const //nc
    {
