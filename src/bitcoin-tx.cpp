...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s nc-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  nc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nc transaction") + "\n" +
              "  nc-tx [options] -create [commands]   " + _("Create hex-encoded nc transaction") + "\n" +
              "\n";
