...
QString BitcoinUnits::longName(int unit)
{
    switch(unit)
    {
    case BTC: return QString("NC");
    case mBTC: return QString("mNC");
    case uBTC: return QString::fromUtf8("μNC");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Ncs");
    case mBTC: return QString("Milli-Ncs (1 / 1" THIN_SP_UTF8 "000)");
    case uBTC: return QString("Micro-Ncs (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
    default: return QString("???");
    }
}
