    ...
    platformStyle(_platformStyle)
{
    ...
    NRCTokenPage = new NRCToken(platformStyle);
...
void WalletView::setClientModel(ClientModel *_clientModel)
{
    ...
    NRCTokenPage->setClientModel(_clientModel);
}
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    NRCTokenPage->setModel(_walletModel);
...
{
    setCurrentWidget(NRCTokenPage);
    NRCTokenPage->on_goToSendTokenPage();
}

void WalletView::gotoReceiveTokenPage()
{
    setCurrentWidget(NRCTokenPage);
    NRCTokenPage->on_goToReceiveTokenPage();
}

void WalletView::gotoAddTokenPage()
{
    setCurrentWidget(NRCTokenPage);
    NRCTokenPage->on_goToAddTokenPage();
}
