#ifndef NCVERSIONCHECKER_H
#define NCVERSIONCHECKER_H

#include <QObject>

#define NC_RELEASES "https://github.com/ncproject/nc/releases"
...
class NcVersionChecker : public QObject
{
    Q_OBJECT
public:
    explicit NcVersionChecker(QObject *parent = 0);
    ~NcVersionChecker();
