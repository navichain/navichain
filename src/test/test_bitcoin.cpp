...
////////////////////////////////////////////////////////////// nc
        ...
        globalState = std::unique_ptr<NcState>(new NcState(dev::u256(0), NcState::openDB(pathTemp.string(), hashDB, dev::WithExisting::Trust), pathTemp.string(), dev::eth::BaseState::Empty));
        dev::eth::ChainParams cp((dev::eth::genesisInfo(dev::eth::Network::ncTestNetwork)));
