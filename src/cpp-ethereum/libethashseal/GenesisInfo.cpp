...
#include "genesis/ncMainNetwork.cpp"
#include "genesis/ncTestNetwork.cpp"
...
std::string const& dev::eth::genesisInfo(Network _n)
{
	...
	case Network::ncMainNetwork: return c_genesisInfoNcMainNetwork;
	case Network::ncTestNetwork: return c_genesisInfoNcTestNetwork;
	default:
...
h256 const& dev::eth::genesisStateRoot(Network _n)
{
	...
	case Network::ncMainNetwork: return c_genesisStateRootNcMainNetwork;
	case Network::ncTestNetwork: return c_genesisStateRootNcTestNetwork;
	default:
		throw std::invalid_argument("Invalid network value");
	}
}
