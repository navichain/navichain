...
////////////////////////////////////////////////////////////// // nc
	void setNcSchedule(EVMSchedule _ncSchedule) const { ncSchedule = _ncSchedule; }

	EVMSchedule& getNcSchedule() const { return ncSchedule; }
...
private:
	...
	mutable EVMSchedule ncSchedule; // nc
