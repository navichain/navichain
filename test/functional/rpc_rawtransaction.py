...
from test_framework.ncconfig import INITIAL_BLOCK_REWARD, COINBASE_MATURITY
...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-5, "Invalid Nc address", self.nodes[0].createrawtransaction, [], {'foo': 0})
